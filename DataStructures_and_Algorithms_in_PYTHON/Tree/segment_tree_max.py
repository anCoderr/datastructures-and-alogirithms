...
##########################################################################################
##########################################################################################
##### Segment Tree for Range Max + Point/Range Update without LAZY PROPOGATION
...
##########################################################################################
##########################################################################################
##### Segment Tree for Range Max + Point/Range Update with LAZY PROPOGATION
class SegmentTreeRangeMaxLazy:
    def __init__(self, data):
        self.n = len(data)
        self.seg_tree = [0] * (2 ** int(math.ceil(math.log2(self.n)) + 1) - 1)
...
st = SegmentTreeRangeMaxLazy([7,9,2,4,10,1,1,3,5,2,4,11,0,2,0,1])
print(st.seg_tree)
print(st.range_max_query(0, 15))
print(st.range_max_query(3, 11))
