...
class WeightedGraphComparatorBasedOnWeight implements Comparator<Edge> {
    @Override
...
class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Undirected Unweighted Graph Traversal");
        undirGraphUnweighted.BFS_traversal(0);
        System.out.println("Undirected Weighted Graph Traversal");
        undirGraphWeighted.BFS_traversal(0);
        System.out.println("Directed Weighted Graph Traversal");
        dirGraphWeighted.BFS_traversal(0);
        System.out.println("Directed Unweighted Graph Traversal");
        ...
        System.out.println("Undirected Unweighted Graph Searching");
        undirGraphUnweighted.BFS_search(0, 4);
        System.out.println("Undirected Weighted Graph Searching");
        undirGraphWeighted.BFS_search(0, 4);
        System.out.println("Directed Weighted Graph Searching");
        dirGraphWeighted.BFS_search(0, 4);
        System.out.println("Directed Unweighted Graph Searching");
        ...
        System.out.println("Directed Unweighted Graph Topological Sort with DFS");
        dirGraphUnweighted.topologicalSort_DFS();
        System.out.println("Directed Weighted Graph Topological Sort with DFS");
        dirGraphWeighted.topologicalSort_DFS();
        System.out.println("Directed Unweighted Graph Topological Sort with BFS");
        dirGraphUnweighted.topologicalSorting_BFS();
        System.out.println("Directed Unwighted Graph Topological Sort with DFS Stack Kahn's Algorithm");
        dirGraphUnweighted.topologicalSorting_DFS_KhansAlgo();
        System.out.println("Directed Weighted Graph Topological Sort with BFS");
        dirGraphWeighted.topologicalSorting_BFS();
        System.out.println("Directed Weighted Graph Topological Sort with DFS Stack Kahn's Algorithm");
        ...
        undirGraphWeighted.printEdgeList();
        System.out.println("Undirected Unweighted Graph Cycle Detection with DFS Recursion");
        System.out.println(undirGraphUnweighted.DetectCycle_DFS_Recursion_Undirected());
        System.out.println("Undirected Unweighted Graph Cycle Detection with DFS Stack");
        System.out.println(undirGraphUnweighted.DetectCycle_DFS_Stack_Undirected());
        System.out.println("Undirected Unweighted Graph Cycle Detection with BFS");
        System.out.println(undirGraphUnweighted.DetectCycle_BFS_Undirected());
        System.out.println("Undirected Unweighted Graph Cycle Detection with Disjoint Sets");
        System.out.println(undirGraphUnweighted.DetectCycle_DisjointSets_Undirected());

        System.out.println("Undirected Weighted Graph Cycle Detection with DFS Recursion");
        System.out.println(undirGraphWeighted.DetectCycle_DFS_Recursion_Undirected());
        System.out.println("Undirected Weighted Graph Cycle Detection with DFS Stack");
        System.out.println(undirGraphWeighted.DetectCycle_DFS_Stack_Undirected());
        System.out.println("Undirected Weighted Graph Cycle Detection with BFS");
        ...
        dirGraphUnweighted.printEdgeList();
        System.out.println("Directed Unweighted Graph Cycle Detection with DFS Recursion");
        System.out.println(dirGraphUnweighted.DetectCycle_DFS_Recursion_Directed());
        System.out.println("Directed Weighted Graph Cycle Detection with DFS Stack");
        System.out.println(dirGraphUnweighted.DetectCycle_DFS_Stack_Directed());
        System.out.println("Directed Unweighted Graph Cycle Detection with BFS");
        System.out.println(dirGraphUnweighted.DetectCycle_BFS_Directed());

        System.out.println("Directed Weighted Graph Cycle Detection with DFS Recursion");
        ...
        System.out.println("Directed Weighted Graph Cycle Detection with BFS");
        ...
        System.out.println("Undirected Weighted Graph Prims Algorithm MST");
        undirGraphWeighted.PrimsAlgo();
        System.out.println("Undirected Unweighted Graph Prims Algorithm MST");
        undirGraphUnweighted.PrimsAlgo();
        System.out.println("Undirected Weighted Graph Kruskal's Algorithm MST");
        undirGraphWeighted.KruskalAlgo();
        System.out.println("Undirected Unweighted Graph Kruskal's Algorithm MST");
        undirGraphUnweighted.KruskalAlgo();

        /* ---------------------------------------- Shortest Path b/w nodes ---------------------------------------- */
        System.out.println("Minimum distances b/w nodes");
        System.out.println("Directed Weighted Graph Shortest Distance from a node");
        dirGraphWeighted.shortestPathInDAG(0);
        System.out.println("Directed Weighted Graph Dijkstra's Algorithm");
        dirGraphWeighted.dijkstraAlgorithm(0);
        System.out.println("Directed Weighted Graph Bellman Ford Algorithm");
        ...
        System.out.println("Directed Unweighted Graph Kosaraju Algorithm");
        dirUnweightedStronglyConnectedGraph.kosarajuAlgorithm();
        System.out.println("Directed Weighted Graph Kosaraju Algorithm");
        dirWeightedStronglyConnectedGraph.kosarajuAlgorithm();
        System.out.println("Directed Unweighted Graph Tarjan's Algorithm");
        dirUnweightedStronglyConnectedGraph.tarjansAlgorithm();
        System.out.println("Directed Weighted Graph Tarjan's Algorithm");
        ...
        System.out.println("Graph Articulation Points");
...
class Graph {
    ...
    public int KruskalAlgo() {
        ...
        DisjointSets ds = new DisjointSets(v);
        sortedEdgeList.sort(new WeightedGraphComparatorBasedOnWeight());
...
// Basic implementation of Combined Graph --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
/*******************************************************************************************************************************************************************************************************************
 *******************************************************************************************************************************************************************************************************************
 *******************************************************************************************************************************************************************************************************************
 *******************************************************************************************************************************************************************************************************************
...
// Basic implementation of Weighted Graph --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
/*******************************************************************************************************************************************************************************************************************
 *******************************************************************************************************************************************************************************************************************
 *******************************************************************************************************************************************************************************************************************
 *******************************************************************************************************************************************************************************************************************
