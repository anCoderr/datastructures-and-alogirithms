...
public class KadanesAlgorithm {
    ...
    public static int maxSubArraySum(int[] nums) {
        int maxSum = Integer.MIN_VALUE, maxTill = 0;
        for(int i : nums) {
            /*Checking if adding this value to the value
                of current +ve sum batch of any benefit to us.*/
            maxTill = Math.max(i, maxTill + i);
            /*Checking if adding this value to the value of
                the max sum till now of any benefit to us.*/
